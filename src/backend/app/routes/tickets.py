...
def update_ticket_status(ticket_id: str, payload: StatusUpdate):
    try:
        ...
        response = supabase.table("tickets").update({"status": payload.status}).eq("ticket_id", ticket_id).execute()
...
def delete_ticket(ticket_id: str):
    try:
        ...
        response = supabase.table("tickets").delete().eq("ticket_id", ticket_id).execute()
